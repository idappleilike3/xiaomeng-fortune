 ...
 * Product prices are NOT hard-coded here — CTAs open L2 pricing / payment stub.
 */
...
/** @typedef {{ id: string, title: string, blurb: string, pricingRoute: string, needIds: string[], topicIds: string[] }} RecommendProduct */
 ...
 * No prices in catalog — open pricingRoute for shelf truth.
