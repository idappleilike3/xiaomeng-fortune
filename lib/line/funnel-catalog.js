...
/** Soft pastel fills for Layer-1 topic rows (dark label text on colored boxes). */
export const TOPIC_BUTTON_COLORS = {
  love: "#F5B8C8",
  pet: "#A8D8C8",
  work: "#A8C4E0",
  wealth: "#F0D090",
...
export const TOPICS = [
  {
    id: "love",
    label: "❤️ 感情關係",
    hint: "看懂對方的態度、關係變化,以及自己下一步該怎麼做",
  },
  {
    id: "pet",
    label: "🐾 萌寵心語",
    hint: "了解牠們在想什麼、行為改變的訊號,以及你們之間更深一層的連結",
  },
  {
    id: "work",
    label: "💼 工作事業",
    hint: "看見工作中的盲點、機會,以及目前最值得投入的方向",
  },
  {
    id: "wealth",
    label: "💰 財富金流",
    hint: "看清現在的金錢流動、機會與風險,找到下一步行動",
  },
  {
    id: "growth",
    label: "🌱 自我成長",
    hint: "釐清你最近最在意的事,重新整理自己的方向與節奏",
  },
  {
    id: "life",
    label: "🧭 生活指引",
    hint: "當你只是想找一個方向,這裡會幫你慢慢理出頭緒",
  },
  {
    id: "other",
    label: "🌌 其他困擾",
    hint: "任何還沒整理好的事情,都可以從這裡開始",
  },
];
...
/**
 * Free 3-card funnel deck — Major Arcana only (22 cards, all have public PNG faces).
 * Prefer tarot-new-* (served via PUBLIC_BASE_URL on Render HTTPS).
 * Copy: Taiwanese spoken, no sentence-ending 「。」, no AI / 小夢 branding.
 *
 * Paid / deep readings use the full 78-card deck in `./tarot-deck-78.js`
 * (`TAROT_DECK_78`) — do NOT expand this free array to minors.
 *
 * @typedef {{
 *   id: string,
 *   name: string,
